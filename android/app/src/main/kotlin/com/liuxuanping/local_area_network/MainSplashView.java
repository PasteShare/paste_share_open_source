...
public class MainSplashView extends FrameLayout {
    private static String TAG = "MainSplashView";
    ...
    public MainSplashView(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        MainSplashView.SavedState savedState = new MainSplashView.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        MainSplashView.SavedState savedState = (MainSplashView.SavedState) state;
     ...
     *
     * <p>If no {@code splashScreen} is provided, this {@code MainSplashView} displays the given
    ...
    public static class SavedState extends BaseSavedState {
        public static Creator<SavedState> CREATOR =
                new Creator<SavedState>() {
                    @Override
                    public MainSplashView.SavedState createFromParcel(Parcel source) {
                        return new MainSplashView.SavedState(source);
                    }

                    @Override
                    public MainSplashView.SavedState[] newArray(int size) {
                        return new MainSplashView.SavedState[size];
                    }
                };
