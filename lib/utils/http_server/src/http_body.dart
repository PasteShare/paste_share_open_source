...
class HttpBodyHandler
  ...
  static Future<HttpRequestBody> processRequest(HttpRequest request,
      {Encoding defaultEncoding = utf8, callback}) async {
    try {
      var body = await _process(request, request.headers, defaultEncoding, callback: callback);
